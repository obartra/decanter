/* Choose which board each level deals, so that difficulty actually rises.
   ...
   Writes src/js/pure/32-order.js as `level: [colours, empties, seed]`. Bump
...
writeFileSync(join(root, 'docs/difficulty.json'), JSON.stringify({
  note: 'Generated by `npm run order`. hard is -log10(chance of playing par at random). See tools/difficulty-core.mjs.',
