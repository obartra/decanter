...
| `src/js/` | the rest: browser code. ES modules throughout, bundled from `src/js/main.js` |
| `src/js/main.js` | the app's entry point, and the one place anything is put on `globalThis` |
