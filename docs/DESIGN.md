...
| [17 The Cellar Door](design/17-casks.md) | The sliding puzzle at `/casks/`: its rules, why its boards ship as a table, and the eleven of them that gate the chapters |
